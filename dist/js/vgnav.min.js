...
var i=e.children("ul");if("sidebar"===this.settings.layout){var j,k=b.find("."+a.classes.sidebar),l=a.settings.sidebar||!1,m="right";if(b.find("."+a.classes.collapse).remove(),l){var n=l.width||!1;m=l.placement||m,n&&(a.setWidthToSidebar(d,n),c.on("resize",function(){a.setWidthToSidebar($(this).width(),n)}))}h&&(k.length?(j=k.detach(),b.append(j),k.addClass(m)):(b.append("<div class=\""+a.classes.sidebar+" "+m+"\"><div class=\""+a.classes.sidebar+"__close\" data-dismiss=\""+a.classes.sidebar+"\">&times;</div><div class=\""+a.classes.sidebar+"__content\"></div></div>"),a.cloneNavigation(b.find("."+a.classes.sidebar+"__content"),i)),b.append("<div class=\""+a.classes.overlay+" "+m+"\"></div>"))}else"collapse"===a.settings.layout&&a.cloneNavigation(b.find("."+a.classes.collapse),i)}toggle(a){var b=this,c=$("body"),d=$(document),e=$(b.classes.container).find("li a"),f=$(b.container).find("."+b.classes.hamburger),g=$(b.classes.container);a&&"afterInit"in a&&"function"==typeof a.afterInit&&a.afterInit(b),d.on("click","."+b.classes.container+" li.dropdown a",function(){if(!b.clickable()){var a=$(this),c=a.parent("li");if($(".dropdown-mega").removeClass("show"),c.parent("ul").hasClass(b.classes.container)){var d=g.find(".show");return d.hasClass("current")&&d.removeClass("show"),c.hasClass("current")?c.removeClass("show").removeClass("current"):(c.addClass("show").addClass("current"),d.removeClass("current")),!1}if(c.hasClass("show"))a.parent("li").removeClass("show"),c.parent("ul").hasClass(b.classes.container)&&g.find(".show").removeClass("show");else if(0<a.parent("li").children("ul").length)return a.parent("li").addClass("show"),!1}}),d.on("click","."+b.classes.container+" li.dropdown-mega a",function(){if(!b.clickable()){var a=$(this),c=a.parent("li");return c.hasClass("show")?c.removeClass("show"):(g.find(".show").removeClass("show").removeClass("current"),c.addClass("show")),!1}}),d.on("click","."+b.classes.container+" li.dropdown a",function(){a&&"afterClick"in a&&"function"==typeof a.afterClick&&a.afterClick(b,this)}),f.on("click",function(){if($(b.container).find("."+b.classes.hamburger).toggleClass("show"),"sidebar"!==b.settings.layout)"collapse"===b.settings.layout&&c.find("."+b.classes.collapse).toggleClass("show");else if(c.find("."+b.classes.sidebar).toggleClass("show"),c.find("."+b.classes.overlay).toggleClass("show"),!c.hasClass("vg-sidebar-open")){var a=window.innerWidth-document.documentElement.clientWidth;c.addClass("vg-sidebar-open").css("padding-right",a)}else c.removeClass("vg-sidebar-open").css("padding-right",0);return!1}),b.settings.hover&&e.hover(function(){a&&"afterHover"in a&&"function"==typeof a.afterHover&&a.afterHover(b,this)}),b.dispose()}dispose(){var a=this,b=$("body"),c=$(document),d=$(a.container).children("ul");c.on("click","."+a.classes.overlay+", [data-dismiss=vg-nav-sidebar]",function(){return b.find("."+a.classes.hamburger).removeClass("show"),"sidebar"===a.settings.layout?(b.find("."+a.classes.sidebar).removeClass("show"),b.find("."+a.classes.overlay).removeClass("show"),b.hasClass("vg-sidebar-open")&&b.removeClass("vg-sidebar-open").css("padding-right",0)):"collapse"===a.settings.layout&&b.find("."+a.classes.collapse).removeClass("show"),!1}),c.mouseup(function(b){var c=$("."+a.classes.container);0===c.has(b.target).length&&d.find(".show").removeClass("show").removeClass("current")})}cloneNavigation(a,b){var c=b.clone().addClass(this.classes.cloned);a.append(c)}setWidthToSidebar(a,b){var c=$("."+this.classes.sidebar);// xl
